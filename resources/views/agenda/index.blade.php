...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        ...
        @endif
        <table class="table table-bordered table-striped table-hover table-sm" id="t_agenda">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Nama Agenda</th>
    ...
    $(document).ready(function() {
        dataAgenda = $('#table_agenda').DataTable({
            ...
            columns: [
                ...
                {
                    data: "kegiatan.nama_jenis_kegiatan", // Assuming 'kegiatan' relation
                    className: "",
                    orderable: true,
                    searchable: true
                },
                {
                    data: "jabatan_kegiatan", 
                    className: "",
                    orderable: false,
                    searchable: true
                },
