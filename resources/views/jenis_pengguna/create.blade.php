<form action="{{ url('/jenis_kegiatan/store') }}" method="POST" id="form-tambah-jenis-pengguna">
    @csrf
...
<script>
    $(document).ready(function() {
        $("#form-tambah-jenis-pengguna").validate({
            rules: {
                kode_jenis_pengguna: { required: true, minlength: 3 },
                nama_jenis_pengguna: { required: true, minlength: 3 }
            },
