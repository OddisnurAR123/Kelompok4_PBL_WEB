...
Route::middleware(['auth'])->group(function(){
    ...
    Route::middleware(['authorize:ADM'])->group(function () {
        ...
        Route::post('/kategori_kegiatan/store', [KategoriKegiatanController::class, 'store'])->name('kategori_kegiatan.store');
    ...
    Route::middleware(['authorize:ADM,DSN'])->group(function () {
       //route kegiatan
        ...
        Route::get('/create', [KegiatanController::class, 'create'])->name('kegiatan.create'); //adm
        Route::post('/store', [KegiatanController::class, 'store'])->name('kegiatan.store'); //adm
        Route::get('/{id}/edit', [KegiatanController::class, 'edit'])->name('kegiatan.edit'); //adm
        Route::put('/update/{id_kegiatan}', [KegiatanController::class, 'update'])->name('kegiatan.update'); //adm
        Route::get('/{id}/delete', [KegiatanController::class, 'confirm'])->name('kegiatan.delete'); //adm
        Route::delete('/{id}', [KegiatanController::class, 'delete'])->name('kegiatan.destroy'); //adm
        Route::get('/import', [KegiatanController::class, 'import'])->name('kegiatan.import'); //adm
        Route::post('/import_ajax', [KegiatanController::class, 'import_ajax'])->name('kegiatan.import.ajax'); //adm
        Route::get('/export_excel', [KegiatanController::class, 'export_excel'])->name('kegiatan.export.excel'); //adm
        Route::get('/export_pdf', [KegiatanController::class, 'export_pdf'])->name('kegiatan.export.pdf'); //adm
    });
...
>>>>>>> 15aa86715d184a53f80f7d81adb17d2b91b085bd
    ...
    Route::middleware(['authorize:PIM,DSN'])->group(function () {
